    ...
    <div className="flex h-screen bg-slate-950 text-slate-100 select-none overflow-hidden">
      ...
      <aside className="w-[140px] bg-slate-900/80 border-r border-slate-800/60 flex flex-col shrink-0 items-center">
        ...
        <div className="mb-4 flex items-center gap-2 px-3">
          <img src="/logo.png" alt="Penny" className="w-10 h-10 rounded-lg shadow-lg shrink-0" draggable={false} />
          <span className="text-2xl font-light text-slate-200 tracking-wide" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Inter', 'Segoe UI', system-ui, sans-serif", letterSpacing: '0.08em' }}>Penny</span>
        </div>
