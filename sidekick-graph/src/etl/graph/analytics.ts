...
export async function runCommunityDetection(): Promise<void> {
...
export async function runBetweennessCentrality(): Promise<void> {
  const session = getSession();
  try {
    await session.run(`
...
export async function runAllAnalytics(): Promise<void> {
