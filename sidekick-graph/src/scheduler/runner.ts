/**
 * Sidekick Scheduler Runner
 *
 * Reads schedule.yaml, checks what's due, and executes jobs.
 * Designed to be invoked every minute by a single crontab entry:
 *
 *   * * * * * cd /Users/fuzeelogik/sidekick/sidekick-graph && ./node_modules/.bin/tsx src/scheduler/runner.ts >> logs/scheduler.log 2>&1
 *
