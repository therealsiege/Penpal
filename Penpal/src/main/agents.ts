...
/** Resolves to the folder containing agent-types.yaml (dev: Penpal/agents, packaged: app.asar/agents). */
...
const STATE_FILE = path.join(getDataDir(), 'agent-sessions.json')
