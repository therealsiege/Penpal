...
export const vaultReadSchema = {
  name: "vault_read",
  description:
    "Read a file from the Obsidian vault. Returns file content, parsed YAML frontmatter, backlinks (files linking to this one), and related files in the same folder.",
  inputSchema: {
...
export async function vaultRead(args: { path: string }): Promise<string> {
