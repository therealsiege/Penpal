# Sidekick Shared Agent Memory

This file is shared across all agents in the Sidekick platform. Reference it for team-wide conventions, patterns, and decisions.

## Architecture

- **Electron Dashboard**: `sidekick-electron/` — React + Tailwind + Phaser game view
- **Graph ETL + MCP**: `sidekick-graph/` — Memgraph + Qdrant knowledge graph
- **Vault Root**: `/Users/fuzeelogik/sidekick/` (Obsidian vault)
