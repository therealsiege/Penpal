...
export const findSimilarSchema = {
    name: "find_similar",
    description: "Find documents or chunks similar to a given text or document path. Uses vector cosine similarity for semantic matching.",
    inputSchema: {
        type: "object",
        properties: {
            text: {
...
export async function findSimilar(args) {
    ...
    if (args.documentPath) {
        ...
        queryVector = scrollResult.points[0].vector;
    }
    else {
