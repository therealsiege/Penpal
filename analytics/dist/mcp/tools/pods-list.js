...
export const podsListSchema = {
    name: "pods_list",
    description: "List all pod workflows. Returns workflows grouped by status with summary counts. Filter by status: active (pending/solving/reviewing/executing/feedback/paused), complete, or failed.",
    inputSchema: {
        type: "object",
        properties: {
            status: {
                type: "string",
                description: 'Filter by workflow status group: "active", "complete", or "failed". Omit for all workflows.',
...
export async function podsList(args) {
