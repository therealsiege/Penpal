...
export const graphStatsSchema = {
    name: "graph_stats",
    description: "Get knowledge graph statistics: node and edge counts by type, lead pipeline summary by stage, and data freshness indicators including latest ETL activity.",
    inputSchema: {
        type: "object",
        properties: {},
        required: [],
