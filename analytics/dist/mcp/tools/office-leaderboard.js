...
export const officeLeaderboardSchema = {
    ...
    description: "Get the agent leaderboard ranked by XP. Supports period filters: 'season' (default), 'weekly', or 'alltime'. Includes weekly MVP, rivalry detection, and season info.",
    inputSchema: {
        type: "object",
        properties: {
            period: {
...
export async function officeLeaderboard(args) {
    ...
    const period = args.period || "season";
