import { buildTerritoryNode } from "../graph/node-builder.js";
...
export function getRegion(stateAbbrev) {
    return STATE_TO_REGION[stateAbbrev] || null;
}
const seededTerritories = new Set();
/** Seed territory nodes and hierarchy, then link a lead to its territory */
export function mapLeadToTerritory(importer, leadName, leadCompany, location) {
