...
import { getCompanies, getPeople, getTechnologies, getLeads, getCompetitorProducts, } from "./wiki-queries.js";
import { synthesizeCompany, synthesizePerson, synthesizeTechnology, synthesizeLead, synthesizeProduct, } from "./wiki-synthesizer.js";
// ---------------------------------------------------------------------------
// Constants
// ---------------------------------------------------------------------------
...
// Generator
// ---------------------------------------------------------------------------
export async function generateWiki(session, options = {}) {
...
// log.md
// ---------------------------------------------------------------------------
function appendLog(wikiDir, stats) {
