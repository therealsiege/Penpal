...
export function saveExtractionCache() {
    if (!extractionCache)
        return;
...
async function callWithRetry(anthropic, truncated, retries = 3) {
...
export async function extractWithLLM(documentPath, content) {
