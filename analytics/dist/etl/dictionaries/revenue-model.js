export const programs = [
    {
        ...
        description: "Monthly care management for patients with 2+ chronic conditions. Billable for non-face-to-face clinical staff time (care plans, medication management, coordination).",
    },
    {
        programId: "rpm",
        name: "RPM",
        ...
        payerRequirement: "medicare+commercial",
        description: "Continuous remote monitoring of patient physiological data (BP, glucose, weight, SpO2). Requires FDA-cleared device and 16+ days of data/month.",
    },
    {
        programId: "apcm",
        name: "APCM",
        ...
        description: "New CMS program (2025) rewarding primary care for longitudinal patient management. Cannot be billed alongside CCM. Tiered by complexity (G0556/G0557/G0558).",
    },
    {
        programId: "tcm",
        name: "TCM",
        ...
        payerRequirement: "medicare+commercial",
        description: "Post-discharge care coordination. Contact within 2 business days, face-to-face within 7 or 14 days. High reimbursement ($168-$240/episode).",
    },
    {
        programId: "awv",
        name: "AWV",
        ...
        payerRequirement: "medicare",
        description: "Preventive visit with health risk assessment, screening schedule review, and advance care planning. Not a physical exam — focused on prevention plan.",
    },
    {
        programId: "mips",
        name: "MIPS",
        ...
        payerRequirement: "medicare",
        description: "Performance-based payment adjustment of up to +/- 9% on Medicare Part B. Scored on Quality (30%), Cost (30%), Improvement Activities (15%), Promoting Interoperability (25%).",
    },
];
export const skillRevenueMap = [
    // -- CCM enablers --
    {
