...
export const officeRoomsSchema = {
  name: "office_rooms",
  description:
    "Get the office room layout: room names, agent assignments, occupancy counts, and idle/active/blocked breakdown per room. Includes suggestions about room utilization.",
  inputSchema: {
...
export async function officeRooms(): Promise<string> {
